...
int main(int, char**)
{
    ...
    GLFWwindow* window = glfwCreateWindow((int)(1280 * main_scale), (int)(800 * main_scale), "Cube Simulator", nullptr, nullptr);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 根据编辑器数据更改场景数据
        game_scene.camera.set_near(game_editor.get_camera_near());
        ...
        {
            game_scene.game_object_list[i].transform.Position = game_editor.get_obj_transforms()[i].Position;
            game_scene.game_object_list[i].transform.Scale = game_editor.get_obj_transforms()[i].Scale;

            game_scene.game_object_list[i].transform.Rotation.x = CS_AngleToRadian(
                game_editor.get_obj_transforms()[i].Rotation.x);

            game_scene.game_object_list[i].transform.Rotation.y = CS_AngleToRadian(
                game_editor.get_obj_transforms()[i].Rotation.y);

            game_scene.game_object_list[i].transform.Rotation.z = CS_AngleToRadian(
                game_editor.get_obj_transforms()[i].Rotation.z);
        }
